    ...
    public function rawObfuscatedRequestProvider()
    {
        return array(
            ...
            array(
                ...
                json_encode(array('name' => '***', 'value' => 'bar'), JSON_PRETTY_PRINT)
            ),
            array(
                'PUT',
                '/foo',
                array('Content-Type' => 'application/json', 'Authorization' => '123'),
                json_encode(array('name' => 'baz'), JSON_PRETTY_PRINT),
                "PUT /foo HTTP/1.1" . PHP_EOL . "Content-Type: application/json" . PHP_EOL . "Authorization: ********" . PHP_EOL . PHP_EOL .
                json_encode(array('name' => '***'), JSON_PRETTY_PRINT)
            ),
            array(
                'PUT',
                '/foo',
        ...
        return array(
            ...
            array(
                new ConnectionResponse(
                    ...
                    json_encode(array('name' => 'foo'), JSON_PRETTY_PRINT)
                ),
            ...
            array(
                ...
                json_encode(array('name' => '***', 'value' => 'baz'), JSON_PRETTY_PRINT)
            ),
        );
    }
}
