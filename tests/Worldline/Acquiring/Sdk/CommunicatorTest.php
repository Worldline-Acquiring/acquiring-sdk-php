...
use Worldline\Acquiring\Sdk\TestUtil\AppendingBodyHandler;
...
class CommunicatorTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->defaultResponseClassMap->defaultSuccessResponseClassName = '\Worldline\Acquiring\Sdk\SimpleHttpBinResponse';
        $this->defaultResponseClassMap->defaultErrorResponseClassName = '\Worldline\Acquiring\Sdk\TestUtil\TestErrorResponse';
    }
    ...
    public function testApiRequestGet()
    {
        ...
        $this->assertInstanceOf('\Worldline\Acquiring\Sdk\SimpleHttpBinResponse', $response);
