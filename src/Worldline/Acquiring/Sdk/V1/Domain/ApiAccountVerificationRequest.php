 ...
 */
class ApiAccountVerificationRequest extends DataObject
{
    /**
     * @var CardPaymentDataForVerification|null
     */
    public ?CardPaymentDataForVerification $cardPaymentData = null;
     ...
     */
    public function fromObject(object $object): ApiAccountVerificationRequest
    {
        ...
        if (property_exists($object, 'cardPaymentData')) {
            ...
            $value = new CardPaymentDataForVerification();
